...
public class AIBotBehavior : ControllersParent
{
    ...
    private void HitBall()
    {
        ...
        if (_ballInstance.LastPlayerToApplyForce != null && _trainingManager.GameState == GameState.SERVICE)
